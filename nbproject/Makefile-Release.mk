...
# Test Files
TESTFILES= \
	${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/preflowpush
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/preflowpush: ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc}   -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/preflowpush $^ ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/ProblemTest_nomain.o: ${OBJECTDIR}/ProblemTest.o ProblemTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/ProblemTest.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ProblemTest_nomain.o ProblemTest.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/ProblemTest.o ${OBJECTDIR}/ProblemTest_nomain.o;\
	fi
...
.test-conf:
	@if [ "${TEST}" = "" ]; \
	then  \
	    ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/preflowpush || true; \
	else  \
	    ./${TEST} || true; \
	fi
